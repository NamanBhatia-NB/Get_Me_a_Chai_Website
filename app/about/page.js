    ...
    return (
        <div className='container mx-auto px-8 md:px-4 py-8'>
            ...
            <p className='text-lg mb-6'>
                Get Me a Chai is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It's a space where your fans can directly contribute to your creating endeavours by buying you a chai. Unlock the potential of your fanbase and bring your projects to life.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex items-center mb-6">
                    ...
                    <div>
                        ...
                        <p>Your fans are enthusiastic about collaboarting with you on your projects and creations. Join now to get started.</p>
                    </div>
                </div>
                <div className="flex items-center mb-6">
